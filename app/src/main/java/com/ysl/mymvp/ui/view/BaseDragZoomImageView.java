 ...
 */
//
public class BaseDragZoomImageView extends RelativeLayout implements View.OnTouchListener {
    ...
    public boolean onTouch(View view,MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN:
                mode = MODE_DRAG;
                // 记录ImageView当前的移动位置
                currentMatrix.set(ivIcon.getImageMatrix());
